...
ms.author: edupont
---
# <a name="walkthrough-selling-assembling-and-shipping-kits"></a><a name="walkthrough-selling-assembling-and-shipping-kits"></a><a name="walkthrough-selling-assembling-and-shipping-kits"></a>Exemplarische Vorgehensweise: Verkauf, Montage und Liefern von Kitartikeln
...
5.  Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell Me-Funktion") Symbol. Geben Sie **Element Buch.-Blätter** ein und wählen Sie dann den zugehörigen Link. Die Seite **Artikel Buch.-Blatt** wird geöffnet.  
...
3.  Erstellen Sie zwei Verkaufsauftragszeilen für Debitor 62000, The Device Shop, am Arbeitsdatum mit den folgenden Informationen.  
    ...
    >   
    >  -   Montagekomponente 80210 ist nicht verfügbar. Dies bedeutet, dass die drei angegebenen Einheiten von Bausatz B nicht montiert werden können, angezeigt durch **0** im Feld **Montage möglich** auf der Seite **Montageverfügbarkeit**.  
    >   
...
2.  Öffnen Sie den Montageauftrag für zehn Einheiten des Bausatz A.  
    ...
    Als Nächstes erstellen Sie ein Kommissionierungsbeleg, um die benötigten Komponenten abzurufen.  
...
8.  Öffnen Sie wieder die Seite **Warenausgangsübersicht**.  
    ...
    Beachten Sie, dass auf der Seite **Lagerhausversand** in der Zeile für zehn Einheiten von Bausatz A die Felder **Versandmenge**und **Ausgewählte Menge** jetzt **10** enthalten.  

9. Wählen Sie die Aktion **Postversand** und wählen Sie **Senden**.  

    Das Warenausgangbeleg wird entfernt, was angibt, dass die entsprechenden Lageraktivitäten ausgeführt wurden. Als Nächstes überprüfen Sie, dass der Verkaufsauftrag verarbeitet wurde.  

...
|**Veröffentlichen**|Wählen Sie dieses Feld, wenn Sie möchten, dass die Stapelverarbeitung die Buchung in die Finanzbuchhaltung automatisch vornimmt. Wenn Sie nicht ausgewählt haben, dass die „Lagerregulierung“ in die Finanzbuchhaltung gebucht wird, wird von der Stapelverarbeitung nur ein Testbericht ausgedruckt, der die Werte enthält, die in die Finanzbuchhaltung gebucht werden können, und auf dem folgende Angabe erscheint: **Testbericht (nicht gebucht)**.|

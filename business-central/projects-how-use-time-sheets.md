...
## <a name="create-time-sheets"></a>So erstellen Sie Arbeitszeittabellen
...
## <a name="reopen-a-time-sheet"></a>So öffnen Sie eine Arbeitszeittabelle erneut:
...
4. Wählen Sie die Schaltfläche **OK**. Der Status der Arbeitszeittabellen, Zeile oder Zeilen wechselt auf **Übermittelt**.  

## <a name="view-and-approve-time-sheets-by-job"></a>So zeigen Sie Arbeitszeittabellen nach Projekt an und genehmigen diese
...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell Me-Funktion") Symbol. Geben Sie **Ressourcen Buch.-Blätter** ein, und wählen Sie dann den zugehörigen Link aus.  

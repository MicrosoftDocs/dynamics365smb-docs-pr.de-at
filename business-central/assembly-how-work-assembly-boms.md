...
Sie können über beliebige Verkaufs- und Einkaufsbelege, die einen Montageartikel enthalten, eine spezielle Aktion verwenden, um die Zeile für den Montageartikel durch neue Zeilen für Komponenten zu ersetzen. Diese Aktion kann beispielsweise dann nützlich sein, wenn Sie die Komponenten als Bausatz verkaufen möchten, das den Montageartikel darstellt.

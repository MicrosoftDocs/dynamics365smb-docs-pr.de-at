...
ms.author: soalex
---
# <a name="austria-local-functionality"></a><a name="austria-local-functionality"></a><a name="austria-local-functionality"></a>Lokale Funktion (Österreich)
...
## <a name="feature-availability"></a><a name="feature-availability"></a><a name="feature-availability"></a>Verfügbarkeit der Funktion
...
## <a name="future-legislation-requirements-being-investigated"></a><a name="future-legislation-requirements-being-investigated"></a><a name="future-legislation-requirements-being-investigated"></a>Künftige Anforderungen der Gesetzgebung, die untersucht werden

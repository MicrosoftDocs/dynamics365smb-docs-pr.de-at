...
ms.author: edupont
---
# <a name="create-a-vat-statement"></a><a name="create-a-vat-statement"></a>Erstellen einer MwSt.-Abrechnung
...
## <a name="to-create-a-vat-statement"></a><a name="to-create-a-vat-statement"></a>So erstellen Sie eine MwSt.-Abrechnung

...
## <a name="to-create-a-delivery-reminder-manually"></a><a name="to-create-a-delivery-reminder-manually"></a><a name="to-create-a-delivery-reminder-manually"></a><a name="to-create-a-delivery-reminder-manually"></a>So erstellen Sie Lieferantenbenachrichtigungen manuell

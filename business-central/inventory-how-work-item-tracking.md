...
1. Wählen Sie das Symbol ![Glühbirne, die die Tell Me Funktion öffnet](media/ui-search/search_small.png "Tell Me-Funktion"), geben Sie **Nachverfolgungscodes** ein und wählen Sie dann den entsprechenden Link.  

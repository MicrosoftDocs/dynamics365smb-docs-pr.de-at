...
7. Wählen Sie die Schaltfläche **OK**, um die Zeilen auf der Seite **Verkaufspreis-Arbeitsblatt** mit den neuen Preisvorschlägen auszufüllen, und geben Sie an, dass diese für die gewählte **Verkaufsart** gültig sind.  

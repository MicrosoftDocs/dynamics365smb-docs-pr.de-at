...
3. In manchen Fällen ist der für ein Land definierte **Debitorvorlagencode** nicht ausreichend, um die eine korrekte Berechnung der Steuern zu gewährleisten (z. B. für Länder mit Umsatzsteuer). In diesem Fall könnte der **Steuerbereich** eine nützliche Ergänzung sein.

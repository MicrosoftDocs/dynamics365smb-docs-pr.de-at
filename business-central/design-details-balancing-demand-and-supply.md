...
Bei Auftrag-zu-Auftrag müssen sich Angebot und Nachfrage exakt decken. Das Planungssystem stellt das Angebot sicher. Dies geschieht ohne Berücksichtigung von Auftragsgrößenparametern, Modifikatoren und Mengen im Bestand (mit Ausnahme der Mengen, die sich auf die verknüpften Aufträge beziehen). Aus dem gleichen Grund schlägt das System die Minderung überschüssigen Vorrats vor, wenn der verknüpfte Bedarf vermindert wird.  

...
| An  | Siehe |
| --- | --- |
| Richten Sie die Voraussetzungen für die Verwendung des Anlagenfeatures ein (legen Sie Standardwerte, Anlagenbuchungen, Buchungsgruppen, Verteilungsschlüssel, Buch.-Blätter und Buchungsarten fest). | [Anlagen einrichten](fa-setup.md)|

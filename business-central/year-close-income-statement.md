...
ms.author: jswymer
---
# <a name="closing-income-statement-accounts" />GuV-Konten Nullstellung
...
## <a name="to-run-the-close-income-statement-batch-job" />Verwenden Sie dazu den Stapelverarbeitungsjob GuV-Konten Nullstellung.
...
## <a name="about-the-close-income-statement-batch-job" />Mehr Informationen zum Stapelverarbeitungsjob GuV-Konten Nullstellung.

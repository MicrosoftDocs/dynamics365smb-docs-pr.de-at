...
Bei den Einzahlungen handelt es sich um Bareinnahmen. Daher möchten Sie Ihre Nummernserie möglicherweise für Bareinnahmenjournale wiederverwenden. Wenn Sie zwischen Einträgen von Bankeinzahlungen und Zahlungseingangs Buch.-Blättern unterscheiden müssen, verwenden Sie alternativ eine andere Nummernserie.

Sie müssen außerdem einen Batch-Job für die Vorlage erstellen. Um einen Batchauftrag zu erstellen, wählen Sie auf der Seite **Fibu Buch.-Blattvorlagen** die Aktion **Chargen** aus. Weitere Informationen zu Stapeln finden Sie unter [Buch-Blattvorlagen und Stapel nutzen](ui-work-general-journals.md#use-journal-templates-and-batches).
...
Wenn Sie alle Hauptbucheinträge für die gebuchten Einzahlungszeilen suchen möchten, wechseln Sie zur Seite **Fibujournal**, und verwenden Sie die Aktion **Sachposten**. Die Aktion zeigt alle Hauptbucheinträge an, einschließlich der Einträge für Debitoren und Kreditoren.

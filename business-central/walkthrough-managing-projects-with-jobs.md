...
4.  Wählen Sie im Feld **Basismaßeinheit** die Option **Neu**, um die Seite **Ressourceneinheit** zu öffnen. Wählen Sie im Feld **Code** die Option **Stunde** aus. Wählen Sie die Schaltfläche **OK**.  
5.  Geben Sie auf dem Inforegister **Fakturierung** die folgenden Informationen ein:  
    ...
    -   **MwSt.-Produktbuchungsgruppe**: **MWST 25**  

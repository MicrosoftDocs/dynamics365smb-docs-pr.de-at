...
2. Erstellen Sie Planungszeilen mit den folgenden Informationen:  
    ...
    | Zeile | Zeilenart | Planungsdatum  | Typ        | Anz.   | Menge | VK-Preis |
    |------|-----------|----------------|-------------|-------|----------|------------|
...
3. Wählen Sie die Zeile 1020 und dann die Aktion **Projektplanzeilen** aus. Geben Sie die folgenden Informationen ein:  
    ...
    | Auftrag | Zeilenart | Planungsdatum  | Typ        | Anz.   | Menge | VK-Preis |
    |------|-----------|----------------|-------------|-------|----------|------------|
...
7. Wählen Sie die Schaltfläche **OK**. Dadurch werden alle Projekt-Buchungsblattzeilen basierend auf den von Prakash erstellten Projekt-Buchungsblattzeilen generiert.  
...
8. Erstellen Sie eine Planungszeile mit den folgenden Informationen:
    ...
    | Zeile | Zeilenart | Planungsdatum  | Typ     | Anz.    | Menge |
    |------|-----------|----------------|----------|--------|----------|

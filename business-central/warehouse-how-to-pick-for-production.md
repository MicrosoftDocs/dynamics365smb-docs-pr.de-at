...
## <a name="inventory-movements" />Lagerbewegungen
...
### <a name="to-create-an-inventory-movement-from-the-source-document" />Eine Lagerbewegung vom Herkunftsbeleg aus erstellen
...
## <a name="to-record-the-inventory-movement" />So erfassen Sie die Lagerbewegung

...
-   Eine Artikelpostensituation, wo ein ausgehender Artikelposten und sein verwandter eingehender Artikelposten offen sind.  
     ...
     |Postennr.|Buchungsdatum|Postenart |Belegtyp|Belegnummer|Artikelnr.|Lagerortcode |Menge|Einstandsbetrag (tatsächl.)|Fakturierte Menge|Restmenge|Öffnen|  
     |---------|------------|----------|-------------|------------|--------|-------------|--------|------------------------|-----------------|------------------|----|  
...
|Postennr.|Buchungsdatum|Postenart |Belegtyp|Belegnummer|Artikelnr.|Lagerortcode |Menge|Einstandsbetrag (tatsächl.)|Fakturierte Menge|Restmenge|Öffnen|Storno|  
|---------|------------|----------|-------------|------------|--------|-------------|--------|------------------------|-----------------|------------------|----|---------|

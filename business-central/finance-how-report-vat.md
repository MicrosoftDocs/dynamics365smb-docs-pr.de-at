...
## <a name="about-the-ec-sales-list-report"></a><a name="about-the-ec-sales-list-report"></a><a name="about-the-ec-sales-list-report"></a><a name="ecsaleslist"></a>Info über den „EU-Verkaufsübersicht“-Bericht
...
### <a name="submit-an-ec-sales-list-report"></a><a name="submit-an-ec-sales-list-report"></a><a name="submit-an-ec-sales-list-report"></a>Einen „EU-Verkaufsübersicht“-Bericht übermitteln
...
### <a name="to-set-up-vat-return-periods"></a><a name="to-set-up-vat-return-periods"></a><a name="to-set-up-vat-return-periods"></a>So legen Sie die Perioden für die Umsatzsteuererklärung fest
...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell Me-Funktion") Symbol, geben Sie **Mehrwertsteuer-Rückgabeperioden** ein und wählen Sie dann den zugehörigen Link.  
...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet 3.](media/ui-search/search_small.png "Tell Me-Funktion") Symbol. Geben Sie **EU-Verkaufsübersicht** oder **Mehrwertsteuererklärung** ein, und wählen Sie dann den entsprechenden Link.  

...
---
# <a name="manage-work-across-multiple-companies-in-the-company-hub" /><a name="manage-work-across-multiple-companies-in-the-company-hub"></a>Arbeit über mehrere Unternehmen hinweg im Unternehmens-Hub verwalten
...
## <a name="company-hub-home-page" /><a name="company-hub-home-page"></a>Homepage des Unternehmens-Hubs
...
## <a name="assigned-tasks" /><a name="assigned-tasks"></a>Zugewiesene Aufgaben
...
### <a name="my-user-tasks" /><a name="my-user-tasks"></a>Meine Benutzeraufgaben
...
## <a name="access-the-company-hub" /><a name="access-the-company-hub"></a>Auf den Unternehmens-Hub zugreifen
...
## <a name="set-up-the-company-hub" /><a name="set-up-the-company-hub"></a>Unternehmens-Hub einrichten

...
|-|------------------|------------------|------------------|------------------|  
|**Lagerbestand**|Lagerbestand|Artikelposten|N/Z|Menge|  
...
|**Geplante Zugänge**|Menge in Bestellung|Einkaufszeile|=Reihenfolge|Restauftragsmenge (Basis)|  
|**Geplante Zugänge**|Umlag.-Auftrag Eingang (Menge)|Umlagerungszeile|N/Z|Restauftragsmenge|  
|**Bruttobedarf**|Menge in Auftrag|Verkaufszeile|=Reihenfolge|Restauftragsmenge (Basis)|  

...
## <a name="get-ready-to-use-power-bi" />Vorbereitung auf die Verwendung von Power BI
...
## <a name="track-your-business-kpis-with-power-bi-metrics" />Verfolgen Sie Ihre Geschäfts-KPIs mit Power BI Metriken nach

...
| Integrieren Sie Buchhaltungsstrukturen. | Übertragen Sie Konsolidierungsdaten aus verschiedenen Buchhaltungsstrukturen in Ihre eigene. Integriertes Dateiformat für F&O (verfügbar mit Wave 2, 2020) | [Geschäftsdaten aus anderen Finanzsystemen importieren](across-import-data-configuration-packages.md)<br></br>[Hauptbuchkonten für die Konsolidierung vorbereiten](finance-consolidated-company-reporting-setup.md#glacc) |

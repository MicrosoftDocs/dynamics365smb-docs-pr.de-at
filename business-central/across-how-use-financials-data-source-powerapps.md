...
ms.author: jswymer
---
# <a name="connecting-to-your-business-central-data-to-build-a-business-app-using-power-apps" />Verknüpfung mit Business Central, um eine Geschäfts-App mithilfe von Power Apps zu erstellen
...
## <a name="add-includeprodshortincludesprodshortmd-as-a-data-source-in-power-apps" />[!INCLUDE[prod_short](includes/prod_short.md)] als Datenquelle in Power Apps hinzufügen
...
## <a name="see-related-microsoft-trainingtrainingpathspower-apps-power-automate-business-central" />Siehe verwandte [Microsoft Schulungen](/training/paths/power-apps-power-automate-business-central/)

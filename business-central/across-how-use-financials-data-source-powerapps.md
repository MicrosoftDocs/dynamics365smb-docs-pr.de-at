...
## <a name="add--as-a-data-source-in-power-apps" />[!INCLUDE[prod_short](includes/prod_short.md)] als Datenquelle in Power Apps hinzufügen
...
## <a name="see-related-microsoft-training" />Siehe verwandte [Microsoft Schulungen](/training/paths/power-apps-power-automate-business-central/)

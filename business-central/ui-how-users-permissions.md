...
| ---- | ----- | ------------------------------- |------------------- |
| [Benutzende nach Status](#example-users-by-status) | Lassen Sie sich eine Liste der Benutzenden basierend auf ihrem Status (aktiviert/deaktiviert) anzeigen. | [Benutzer](https://businesscentral.dynamics.com/?page=9800) | **Status**, **Benutzername**, **Vollständiger Name**, **Genehmigungs-E-Mail** und **Lizenztyp**. |
| [Benutzende nach Lizenztyp](#example-users-by-license-type) | Lassen Sie sich eine Liste der Benutzenden basierend auf ihrem Lizenztyp anzeigen. | [Benutzer](https://businesscentral.dynamics.com/?page=9800) | **Lizenztyp**, **Status**, **Benutzername**, **Vollständiger Name** und **Genehmigungs-E-Mail**. |
...
1. Wählen Sie die Felder **Benutzername**, **Vollständiger Name** und **Genehmigungs-E-Mail** aus.

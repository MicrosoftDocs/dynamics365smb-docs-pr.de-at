...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet](media/ui-search/search_small.png "Tell me-Funktion"). Symbol. Geben Sie **Kontenschemata** ein und wählen Sie dann den zugehörigen Link.  
...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet 2.](media/ui-search/search_small.png "Tell me-Funktion") Symbol. Geben Sie **Kontenschemata** ein und wählen Sie dann den zugehörigen Link.
...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet 3.](media/ui-search/search_small.png "Tell me-Funktion") Symbol. Geben Sie **Kontenschemata** ein und wählen Sie dann den zugehörigen Link.
2. Wählen Sie im Fenster **Kontenschemanamen** ein Kontenschema aus.  
...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet 4.](media/ui-search/search_small.png "Tell Me-Funktion") Symbol. Geben Sie **Kontenschemata** ein und wählen Sie dann den zugehörigen Link.

...
> [!WARNING]
> Einige Felder auf dem Bankkonto des Kreditors enthalten sensible Daten, z.B. die Felder **BLZ**, **Bankkontonr.**, **SWIFT Code** und **IBAN Code**. Weitere Informationen finden Sie unter [Überwachen sensibler Felder](across-log-changes.md#monitoring-sensitive-fields).

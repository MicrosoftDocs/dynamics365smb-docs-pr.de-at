...
ms.locfileid: "8130965"
---
# <a name="use-xml-schemas-to-prepare-data-exchange-definitions" /><a name="use-xml-schemas-to-prepare-data-exchange-definitions"></a>Verwenden von XML-Schemata zur Vorbereitung der Datenaustauschdefinitionen
...
## <a name="to-load-an-xml-schema-file" /><a name="to-load-an-xml-schema-file"></a>So laden Sie eine XML-Schemadatei
...
### <a name="to-select-or-clear-nodes-in-an-xml-schema" /><a name="to-select-or-clear-nodes-in-an-xml-schema"></a>So wählen oder löschen Sie Knoten in XML-Schema
...
### <a name="to-generate-a-data-exchange-definition-that-is-based-on-an-xml-schema" /><a name="to-generate-a-data-exchange-definition-that-is-based-on-an-xml-schema"></a>So generieren Sie eine Datenaustauschdefinition, die auf einem XML-Schema basiert

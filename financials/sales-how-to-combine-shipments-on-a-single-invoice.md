...
6. <span data-ttu-id="03020-120">Um die Rechnung zu buchen, wählen Sie die Aktion **Buchen** aus.</span><span class="sxs-lookup"><span data-stu-id="03020-120">To post the invoice, choose the **Post** action.</span></span>  

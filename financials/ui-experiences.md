...
> [!NOTE]  
> Mit der Sandboxoption können Sie die **Erweitert** Erfahrung auswählen, die Zugriff auf alle möglichen Geschäftsfunktionalität gibt, einschließlich Produktion und Dienstleistungs-Verwaltung. Weitere Informationen finden Sie unter [Erstellen einer Sandbox-Umgebung](across-how-create-sandbox-environment.md).

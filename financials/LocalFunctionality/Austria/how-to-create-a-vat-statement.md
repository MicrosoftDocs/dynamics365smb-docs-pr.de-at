...
---
<<<<<<< KOPF:financials/LocalFunctionality/Austria/how-to-create-a-vat-statement.md
# <a name="create-a-vat-statement"></a>Erstellen einer MwSt.-Abrechnung
=======
# <a name="create-a-vat-statement"></a>Erstellen einer MwSt.-Abrechnung
>>>>>>> refs/remotes/origin/Update13:archive/LocalFunctionality/Austria/how-to-create-a-vat-statement.md [!INCLUDE[d365fin](../../includes/d365fin_md.md)] ermöglicht das Einreichen eines periodischen Berichts von MwSt.-Abrechnungen. Die MwSt.-Abrechnung wird als FDF-Datei übermittelt. Dieses Dateiformat entspricht einer bearbeitbaren PDF-Datei der Steuerbehörde.  
